...
**Önceki dilim:** [06-plan-status.md](06-plan-status.md) sonundaki Faz 0 tablosu
...
Son madde değerlendirmenin düzeltmesiydi ve [19-technical-setup.md](19-technical-setup.md) B4 tablosundaki "Açık" satırını geçersiz kılıyor.
...
**Personel ajan değil, sunucu.** [14-staff-system.md](14-staff-system.md) "karmaşık yol bulma yok" diyor. Simülasyonda personel, iş havuzunda aynı anda tek görev işleyen bir sunucu. Günlük kapasite görev sürelerinden kendiliğinden çıkıyor, ayrıca kodlanmıyor.
...
İlk koşuda **altı gruptan altısı kızgın ayrıldı.** Sebep [12-economy.md](12-economy.md) §5.2'nin kendi içinde çelişmesiydi: sabır 8-40 saniye veriliyor, ama aynı bölüm bir servisin yaklaşık 120 saniye sürdüğünü söylüyor. Tek hızla her müşteri her zaman çıkıp giderdi.
...
**Düzeltme:** kişi başına bir **ana yemek kesin**, yan (%30) ve içecek (%40) olasılıklı. Ortalama 1,7 tabak. Bu, [07-cuisine-system.md](07-cuisine-system.md)'deki kombo mekaniğinin taban hali. Hazırlama süreleri de buna bölündü, çünkü kişi başına bütçe sabit.
...
[12-economy.md](12-economy.md) §5.5 formülü günde +12 puan veriyor. İtibar 30'dan 100'e dokuz günde çıkıyor, yani altmış günlük kampanyanın ana ilerleme ekseni ilk haftada tükeniyor.
...
- **Hiçbir strateji kredi kullanmıyor.** [12-economy.md](12-economy.md) §4 tam olarak bu durum için kredi tanımlıyor: 5.000 sikke, 1,35 kat geri ödeme, sekiz hafta. Sarmalın tabanı bu olmalı ve strateji onu hiç denemiyor.
...
| **Kredi hiç kullanılmıyordu** | `TakeLoan` komutu enum'da duruyor ama uygulanmamıştı | [12-economy.md](12-economy.md) §4 tam bu durum için kredi tanımlıyor. Uygulandı ve strateji kasa iki haftalık gideri karşılamayınca çekiyor |
...
**Bu bir denge sorunu değil, eksik içerik.** [12-economy.md](12-economy.md) §7 üç önlem sayıyor ve ikincisi son kademe ekipmanların 8.000-12.000 sikke olması. Ekipman henüz yazılmamıştı, yani oyuncunun biriktireceği bir şey yoktu.

**10 Eylül 2026 akşamı kapandı.** Ekipman sistemi yazıldı, [27-time-model.md](27-time-model.md) Karar D uygulandı ve ekonomi yeniden dengelendi. Uyarı artık hiçbir stratejide tetiklenmiyor. Ayrıntı, bu turda ölçümün yakaladığı üç hata dahil: [32-equipment-and-rebalance.md](32-equipment-and-rebalance.md).
...
| Sıra | İş | Neden |
|---|---|---|
| 1 | Zirve kararının **uygulanması** ([28-peak-decision.md](28-peak-decision.md)) | Karar verildi: dilim payları değil dilim **süreleri** mutfağa göre değişiyor. Türk mutfağının %60 öğle payı olduğu gibi kalıyor, öğle dilimi günün %48'ini kaplıyor. Günlük kayıp fast food %3,15, Türk %5,08 |
...
| 4 | Komut günlüğü ve kayıt | [23-core-contract.md](23-core-contract.md) §7 |
