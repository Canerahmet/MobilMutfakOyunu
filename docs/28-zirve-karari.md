...
**Durum:** Parti B. Bu dosya bağlayıcıdır ve [27-zaman-modeli.md](27-zaman-modeli.md) Karar F'yi **değiştirir**.
...
[12-ekonomi.md](12-ekonomi.md) §5.6 her mutfağa bir imza saat profili veriyor ve bunu kimliğin kalbi ilan ediyor:
...
[27-zaman-modeli.md](27-zaman-modeli.md) Karar F aynı profili fizik olarak imkânsız buluyor ve `arrivalWeightsBp` değerlerinin hiçbir dilim %30'u aşmayacak şekilde yeniden normalleştirilmesini istiyor. Türk mutfağı için önerdiği profil **%15 / %30 / %30 / %25**. Bu, %60'lık öğle zirvesini siliyor.

### 1.2 İki tarafın sayıları

| Kaynak | Fast food | Türk mutfağı |
|---|---|---|
| [12](12-ekonomi.md) §5.6 tablosu (yazılı) | %15 / %35 / %15 / %35 | %10 / %60 / %20 / %10 |
| `content/archetypes/*.json` (ölçülen) | %11,05 / **%37,49** / %16,20 / %35,26 | %9,37 / **%60,63** / %17,53 / %12,47 |
| [27](27-zaman-modeli.md) Karar F (önerilen) | %20 / %30 / %20 / %30 | %15 / %30 / %30 / %25 |
...
**On ikinci personel yoğunluk tavanını yalnızca 0,7 puan büyütüyor.** [14-personel-sistemi.md](14-personel-sistemi.md)'nin "tavan her kademede gerekenden bir fazla" boşluğu bir hata payı; zirve satın alma kaldıracı değil. Bu, seçenek B'nin neden çalışmadığının kısa hâli.
...
**Bedeli.** Türk mutfağının öğle zirvesi %60,63'ten %30'a iniyor; yoğunluk 2,425'ten 1,200'e. Fast food'un zirvesi 1,500'den 1,200'e. İki mutfağın yoğunluk profili **birbirinin aynısı** oluyor: 1,20 / 1,20 iki dilimde fast food, 1,20 / 1,20 iki dilimde Türk. [07-mutfak-sistemi.md](07-mutfak-sistemi.md)'nin yedi farklılaşma değişkeninden biri olan "ritim" ve [10-mutfak-kimligi.md](10-mutfak-kimligi.md)'nin "kalabalığın ritmi" satırı içerikten tamamen siliniyor. Ayrıca Türk mutfağının akşamı %12,5'ten %25'e çıkıyor, yani "akşam sönük" kimliği de gidiyor.
...
| Sahne | 17 masa 2,5D sahnede kırk derecelik sabit kamerada okunmuyor; [19-teknik-kurulum.md](19-teknik-kurulum.md) kare başına 100 altı çizim çağrısı ve 100 bin altı üçgen istiyor, masa ve müşteri sayısı doğrudan bu bütçeye giriyor |
| Dokunuş | [16](16-ekranlar-ve-ogretici.md) günlük 40-60 dokunuş tavanı koyuyor; 16 personelin sabah istasyon ataması tek başına o bütçeyi yiyor |
...
| Kalem | Ne |
|---|---|
| Aritmetik | [27](27-zaman-modeli.md) §5.3'ün "azami dilim payı %28,2" cümlesi genelleşiyor: azami **yoğunluk** 1,1262 |
...
**%60,63 duruyor.** [12](12-ekonomi.md) §5.6'nın cümlesi hâlâ doğru: lokantada müşterilerin yüzde altmışı tek dilimde geliyor. Değişen şey, o dilimin günün dörtte biri değil, **neredeyse yarısı** olması.
...
**Hafta içi her kademede sıfır.** Kadro hafta sonu zirvesine kurulu, hafta içi %20 daha az müşteri geliyor; kuyruk hiç oluşmuyor. [14](14-personel-sistemi.md)'ün "kadro zirveye kurulur, ücreti yedi gün ödenir" kararının doğrudan görünür karşılığı bu.

**En sert hafta yedinci hafta, en sert an son genişlemenin ertesi.** 92 müşteri, 4 aşçı ve 6 salon personeliyle karşılanıyor; `ceil()` yuvarlaması burada en sıkı. [12](12-ekonomi.md) §6 zaten yedinci haftayı "bilinçli bir kumar" diye tanımlıyor. Kayıp eğrisi anlatıyı doğruluyor.

**Birinci haftanın hafta sonunda bir müşteri kaybediliyor.** %5,89 × 17 = 1,00 kişi (Türk'te %7,68 × 17 = 1,31). Bu bir kaza değil, öğreticinin eksik parçası: [review/05-oyuncu-deneyimi.md](review/05-oyuncu-deneyimi.md) "ilk işe alımı oyuncunun gözle gördüğü ilk bekleme kaybının ertesi sabahına koyun" diyordu. Kapasite modeli o kaybı zaten altıncı veya yedinci günde üretiyor. İlk garsonun işe alınma sebebi böylece senaryodan değil aritmetikten geliyor.
...
Bir günün itibar değişimi ([12](12-ekonomi.md) §5.5): `Σ (memnuniyet − 60) × itibar_ağırlığı / 100`. Çıkıp giden müşterinin memnuniyeti, sabrı tam tükendiği an `100 − (sabır ÷ sabır) × 60 = 40`.
...
[12](12-ekonomi.md) §5.6 dört mutfak tanımlıyor. İtalyan ve Japon arketip havuzları henüz yazılmadı; süreleri aynı kuralla, yalnızca yoğunluk tavanından türetiliyor:
...
İkisi de tavanın altında. İtalyan'ın kayıp sayısı hesaplanamıyor çünkü `T_EAT_PARTY` mutfağa göre değişecek ([27](27-zaman-modeli.md) karar bekleyen madde 1) ve İtalyan'da uzayacak; uzun oturma masa havuzunu bağlayıcı hâle getirebilir. **Bu iki satır bağlayıcı değil**, dilim süresi mekanizmasının dört mutfağın hepsini taşıyabildiğinin ispatı.
...
**Aradaki fark 1,2 puan.** Oyuncu, öğle zirvesinin lokantada fast food'dakinden daha sert olduğunu **hissedemez**, çünkü değil. [12](12-ekonomi.md) §5.6'nın "öğle zirvesini gerçek bir kriz anına çeviriyor" cümlesi, "fast food'dakinden daha büyük bir krize" anlamında okunuyorsa **yanlış** ve bu kararla da doğru olmuyor. Hiçbir seçenekle doğru olamıyordu: seçenek B onu 26 personel ve 28 masayla satın alıyordu, o da tavanların iki katı.
...
[07](07-mutfak-sistemi.md)'nin yedi farklılaşma değişkeninden "ritim" satırı **daralıyor ama silinmiyor**. Daralan kısım şiddet, korunan kısım süre ve süreklilik. Seçenek A bu satırı tamamen siliyordu; Karar G iki üçünü kurtarıyor.

Buna karşılık, kimlik yükünün bir kısmı başka direklere kayıyor. [07](07-mutfak-sistemi.md)'nin kendi listesinde ritmin altında **imza mekaniği** var ve "en önemli satır" olarak işaretli: fast food'da kombo ve akış, Türk'te veresiye ve düzenli müşteri. Ritmin taşıyamadığı ayrımı taşıyacak yer orası, ve [review/01-tasarim-ve-denge.md](review/01-tasarim-ve-denge.md) veresiyenin şu hâliyle "vergi" olduğunu, tutar, vade, tahsilat takvimi ve ödememe olasılığının yazılmadığını zaten söylemişti. **Ritim küçüldüğü için veresiyenin yazılması artık isteğe bağlı değil.** Bu bir bağımlılık ve bu kararın bedeli.
...
| [12-ekonomi.md](12-ekonomi.md) §5.6 | Tablo iki sütunlu olacak: pay **ve** süre. Yazılı değerler ölçülen değerlerle değiştirilecek (bölüm 1.2). "Yüzde altmışı tek dilimde" cümlesi kalacak, "dilim günün %48'i" eklenecek | Yazılı tablo içerikle tutmuyordu |
| [27-zaman-modeli.md](27-zaman-modeli.md) §5.3, §5.4, §5.5, Karar F | Karar F **değiştirildi**. "Azami dilim payı %28,2" → "azami yoğunluk 1,1262; eşit dilimde %28,2". §5.4 seçenek 3 ve §5.5'teki normalleştirme önerileri iptal | Bu dosya |
| [27-zaman-modeli.md](27-zaman-modeli.md) §8 | `content/archetypes/*.json` satırlarındaki `arrivalWeightsBp` işleri silinecek | Aynı |
| [27-zaman-modeli.md](27-zaman-modeli.md) §7 | `Azami dilim payı %28,2` satırı `Azami yoğunluk 1,1262` olacak | Aynı |
| [27-zaman-modeli.md](27-zaman-modeli.md) §9 | "46 test" → 47 | Sayı zaten eskiydi; `--check` 47 kontrol yazıyor |
| [23-cekirdek-sozlesmesi.md](23-cekirdek-sozlesmesi.md) | Dilimlerin eşit olmadığı çekirdek sözleşmesine yazılacak | Determinizm sözleşmesi |
| [13-veri-semalari.md](13-veri-semalari.md) | `cuisines/*.json` şeması; §260'taki doğrulama listesine dilim süresi toplamı eklenecek | Şema listesi eksik kalmasın |
| [16-ekranlar-ve-ogretici.md](16-ekranlar-ve-ogretici.md) | Gün ilerleme çubuğu dilimleri **eşit çizmeyecek** | [review/05](review/05-oyuncu-deneyimi.md) sorun 4 zaten dilim işaretli bir ilerleme çubuğu istiyordu; çubuk artık mutfak kimliğini de gösteriyor |
| [10-mutfak-kimligi.md](10-mutfak-kimligi.md) | "Günlük ritim" satırı süre ve süreklilik cinsinden yeniden yazılacak (bölüm 6.2 tablosu) | Ritim direği daraldı, tanımı güncellenmeli |
...
1. **`T_EAT_PARTY` mutfak başına.** [27](27-zaman-modeli.md) karar bekleyen madde 1. Türk mutfağında oturma süresi fast food'un 38.000 ms'sinden uzunsa masa devri uzar, masa havuzu doluluğu %101,6'dan yukarı çıkar ve **bağlayıcı havuz salondan masaya geçebilir.** Geçerse öğle dilimi süresi %48'den yukarı çekilmeli. Bu dosyanın Türk sayıları `T_EAT_PARTY = 38.000` varsayıyor ve bu varsayım muhtemelen yanlış.
...
6. **Dilim içi geliş dağılımı.** Model dilim içinde düzgün dağılım varsayıyor; `BuildArrivalPlan` da öyle yapıyor (`_rngArrival.NextInt(slotTicks)`). Gerçek öğle yoğunluğunun dilim içinde de tepesi vardır. Dilim sayısını dörtten sekize çıkarmak bu ayrıntıyı içeriğe taşırdı; şimdilik açılmadı, çünkü [16](16-ekranlar-ve-ogretici.md)'nın gün ilerleme çubuğunda sekiz dilim okunmaz.
7. **`serviceMs` alanı.** `content/economy.json` hâlâ `serviceMs: 120000` taşıyor. [27](27-zaman-modeli.md) §2.4 bunun `tableTurnMs: 125525` olması gerektiğini söylemişti; hâlâ yapılmadı ve bu dosya o değişikliğe dokunmuyor.
