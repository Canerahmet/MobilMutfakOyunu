...
**Review and measurement** — [22](22-answers-and-direction.md) questions and direction · [37](37-four-agent-review.md) the four-agent review · [43](43-review-and-measurement.md) where the measurement misled us · [45](45-design-review.md) the five-agent design pass · [49](49-unreachable-mechanics.md) mechanics that never reach the player · [57](57-end-to-end-audit.md) the end-to-end audit: the busy slot was the empty one · [58](58-visual-review.md) the visual round: a blank icon, a shadowless floor, an inverted sky · [46](46-shipped-binary.md) the shipped binary, link.xml
