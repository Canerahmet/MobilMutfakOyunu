...
Değerlendirmenin sorularına verilen cevaplar ([22-cevaplar-ve-yon.md](22-cevaplar-ve-yon.md)) bu dosyanın üç varsayımını değiştirdi:

| Varsayım | Eski | Yeni |
|---|---|---|
| Platform | Android + iOS | **Sadece Android.** Mac yok, iOS Mac olunca |
| İlk yıl maliyeti | 124 $ | **25 $** (Google Play). Apple 99 $ ödenmiyor |
| Blender kullanımı | "Sen çalıştırırsın" | **Ben çalıştırırım**, Claude Code uzaktan kontrolle. Render'ı da ben görüyorum. Bkz. [24-sanat-hatti.md](24-sanat-hatti.md) |
