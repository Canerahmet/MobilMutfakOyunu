...
**Değerlendirme kaynağı:** [review/03-kapsam-gercekciligi.md](review/03-kapsam-gercekciligi.md)
...
**Döngüde mesh'e bakan kimse yoktu.** Bu, "prosedürel birincil" kararını ([20-uretim-kararlari.md](20-uretim-kararlari.md)) çalışmaz hâle getiriyordu.
...
| Ses | [17-ses-tasarimi.md](17-ses-tasarimi.md) kaynağı; değerlendirme onayladı (C4) | 0 |
...
Lisans denetim tablosu [21-is-ve-yayin.md](21-is-ve-yayin.md)'de; her varlık oraya kaynak ve lisansıyla yazılır. CC0 dışı hiçbir şey sorulmadan girmez.

---

## Üçgen bütçeleri

[19-teknik-kurulum.md](19-teknik-kurulum.md) sahne bütçesini veriyor. Varlık başına:
...
Sen yemek çeşidinin çok olmasını istedin; tasarımcı "parametreliyse olur" dedi ([23-cekirdek-sozlesmesi.md](23-cekirdek-sozlesmesi.md) §8.3). Sanat tarafında da aynı mantık: **modüler tabaklama.**
