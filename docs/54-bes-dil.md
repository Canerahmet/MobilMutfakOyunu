...
- `unity/Assets/Lokanta/Art/Yazi/NotoSansSC-Lokanta.ttf` — **227.116 bayt**,
...
da OFL" demek lisansı karşılamıyor: `lisans/noto-sans-sc-ofl` ayrı bir dosya
olarak eklendi, künye satırı ve `ATIF.md` kütüğü güncellendi. Tur lisans
