...
"SERVİS SIRASINDA SEN VARSIN" diyor ([44](44-magaza-metinleri.md)) — müdahale,
...
Sorun mekanikte değil, [45](45-tasarim-incelemesi.md) §18'in koruduğu
...
oyunun ödüllendirdiği oyun ([47](47-tanima-ve-karne.md)'nin "Zirveyi eksik
...
1. `link.xml`'i akıl yürütmeyle doğru sayma ([46](46-gonderilen-ikili.md))
2. `badge.` ailesini yalnızca üretece ekleyip teste eklememe
   ([47](47-tanima-ve-karne.md))
