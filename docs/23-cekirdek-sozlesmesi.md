...
**Değerlendirme kaynağı:** [review/02-teknik-mimari.md](review/02-teknik-mimari.md)

---

## Neden bu dosya var

Mimari değerlendirmesi şunu buldu: [04-mimari.md](04-mimari.md) determinizmi **istiyor** ama **tasarlamıyor**. `Tick(deltaTime)` değişken kare süresini çekirdeğe sokuyor, rastgelelik kaynağı belirsiz, kayan nokta üç derleyicide üç farklı sonuç verebiliyor, Türkçe kültür ayarı `ToUpper` çağrısını bozuyor.
...
|---|---|---|
| Bir tick | 1 | 100 ms |
| Bir müşteri servisi | ~1.200 | 120 s, [12-ekonomi.md](12-ekonomi.md) §5.2 |
| Bir servis günü | 4.800 | 8 dakika 1x hızda |
| Altmış günlük sezon | 288.000 | Denge aracı 50 µs/tick ile 15 saniyede biter |

Sabır değerleri ([12-ekonomi.md](12-ekonomi.md) §5.2) saniye cinsinden yazılı; çekirdekte ms olarak tutulur, 8 s = 8.000 ms = 80 tick.
...
[12-ekonomi.md](12-ekonomi.md) §5.1:
...
[15-kayit-sistemi.md](15-kayit-sistemi.md) JSON + gzip + sağlama toplamına karar verdi; değerlendirme bunu onayladı (B6). Bu karar korunuyor. Ama **serileştirme yansımayla değil, elle yazılmış yürüyüşle** yapılır:
...
|---|---|---|
| Gün başına azami komut | 256 | Dokunuş bütçesi 60, [16-ekranlar-ve-ogretici.md](16-ekranlar-ve-ogretici.md); 4 kat pay |
...
Yazma [15-kayit-sistemi.md](15-kayit-sistemi.md) ve [19-teknik-kurulum.md](19-teknik-kurulum.md) kurallarıyla: geçici dosyaya yaz, `Flush(true)`, yeniden adlandır, `.bak` tut, CRC32.
...
Değerlendirme [13-veri-semalari.md](13-veri-semalari.md)'de dört eksik buldu. Hepsi tamsayı birimlerle (§2.2) yazılır.

### 8.1 Personel kapasitesi ve havuz

[14-personel-sistemi.md](14-personel-sistemi.md) iki havuzlu modeli tanımlıyor. Şemaya:
...
| `plating` | Görünüm katmanı için; simülasyon okumaz. Bkz. [24-sanat-hatti.md](24-sanat-hatti.md) |
...
Mac yok, ilk sürüm Android. Çapraz platform testi bir Android cihazla yapılır. Emülatör kabul edilmez ([20-uretim-kararlari.md](20-uretim-kararlari.md)); IL2CPP'nin gerçek ARM derlemesi test ediliyor.
