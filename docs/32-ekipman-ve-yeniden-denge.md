...
10 Eylül 2026. Faz 0'ın açık kalan tek denge uyarısı kapandı: **makul oyuncuda para 5,5. haftada sorun olmaktan çıkıyordu, hedef sekizinci haftadan önce olmamasıydı.** [29-faz0-simulasyon.md](29-faz0-simulasyon.md) bunun bir denge sorunu değil eksik içerik olduğunu yazmıştı. Doğruydu, ama eksik olan yalnızca içerik değildi.

---

## 1. Yazılan şey

[27-zaman-modeli.md](27-zaman-modeli.md) **Karar D**'yi Mart'ta almıştı ama simülasyon onu hiç uygulamamıştı:
...
Son kademe 10.000 sikke — [12-ekonomi.md](12-ekonomi.md) §7'nin istediği 8.000–12.000 bandında. Merdivenin tamamı **48.080 sikke**; makul oyuncunun altmış günlük neti **42.627**. **Yani her şeyi alamıyor, seçmek zorunda** — ve zorunlu olanlar (yuva ekleyenler) 37.640, isteğe bağlı olanlar (asçıyı erken bırakanlar) 10.440. Hedef tam olarak buydu.
...
Ve bu, çok tanıdık bir hataya yol açtı: [06-plan-durumu.md](06-plan-durumu.md)'nun kayıtlı en pahalı hatası, kapalı form modelin talebin tamamının ağırlandığını varsayması ve kiraların o varsayımdan çözülmesiydi. Ölçülen gerçekleşme oranı %65 çıkmış, kiralar %35 fazla olduğu için düşürülmüştü.
...
- Büyümek **2,58 kat** ödüllendiriyor (12.537 → 32.398), [12-ekonomi.md](12-ekonomi.md)'nin "üç kat, on bir değil" bandında.
...
Depo odasının işi yoktu ve [31-oda-ve-kamera.md](31-oda-ve-kamera.md) "iş verilemezse yerleşimden çıkarılmalı" diyordu. İş bulundu ve zaten oradaydı.
...
Bu bir hata değil, **tasarlanmış temel**: [12-ekonomi.md](12-ekonomi.md) §3 "bozulabilir malzeme günü kapatınca değerinin tamamını kaybeder" diyor. O yüzden soğuk hava bir *düzeltme* değil, o temeli **değiştiren yükseltme**.
...
Soğuk hava o kısıtı gevşetiyor, yani **menü genişliği satın aldırıyor** — ve [09-icerik-envanteri.md](09-icerik-envanteri.md)'nin otuz iki yemeğinin var olma sebebi oluyor. İçerik envanteri, hal aşaması ve ekipman merdiveni bu parça olmadan birbirinden kopuktu.
...
- **Ekipman arayüzü yok.** [16-ekranlar-ve-ogretici.md](16-ekranlar-ve-ogretici.md) ekran 14 "Yükseltme ve ekipman" diyor ama içeriği yazılmadı. Oda görünümünde mutfağa dokunmak buraya açılmalı.
- ~~İkinci mutfak (Türk) ölçülmedi.~~ **Ölçüldü ve kırık çıktı**; sebep ekipman değil menü gruplarıydı. Bkz. [33-ikinci-mutfak.md](33-ikinci-mutfak.md). Düzeltmeden sonra aynı ekipman merdiveni ayar gerektirmeden çalışıyor.
- **`attendBp` ekipman kademesiyle düşüyor ama personel deneyimiyle düşmüyor.** [27-zaman-modeli.md](27-zaman-modeli.md) §595 bunu açık bırakmıştı, hâlâ açık.
