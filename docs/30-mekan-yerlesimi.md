...
**Dayanak:** [16-ekranlar-ve-ogretici.md](16-ekranlar-ve-ogretici.md) sonundaki dokunma hedefi ölçümü; `unity/Assets/Lokanta/Editor/RestaurantScene.cs` ve `unity/Assets/Lokanta/Editor/RoomLayout.cs` render'ları; yirmi altı oyunun web araştırması.
