...
**9 Eylül 2026:** 32 kesinleşti. Tasarımcı ve kapsam değerlendirmesinin ortak şartı bağlayıcı: **her yemek dört parametre taşır** (`prepMs`, `station`, `complexity`, `ingredients[].grams`), bkz. [23-cekirdek-sozlesmesi.md](23-cekirdek-sozlesmesi.md) §8.3. Sanat maliyeti modüler tabaklamayla sabit: 32 yemek, 14 mesh, bkz. [24-sanat-hatti.md](24-sanat-hatti.md).

**v2 değişikliği:** Yemek sayısı mutfak başına 20'den 32'ye çıkarıldı. Malzeme, arketip ve düzenli müşteri sayıları buna göre yeniden boyutlandırıldı. Karakter ve ortam farklılaşması ayrı bir dosyaya alındı: [10-mutfak-kimligi.md](10-mutfak-kimligi.md).
...
Arketip davranış kalıbıdır, kişi değil. Sekizi bütün mutfaklarda paylaşılır, on ikisi mutfağa özeldir. Üç sıklık kademesine ayrılırlar: sık, orta, nadir. Tam liste için bkz. [11-musteri-sistemi.md](11-musteri-sistemi.md).
...
Üniforma mutfağa göre değişir. Bkz. [10-mutfak-kimligi.md](10-mutfak-kimligi.md).
