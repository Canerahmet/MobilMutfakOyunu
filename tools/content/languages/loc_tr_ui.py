...
UI = {
    ...
    "notice.critic_expected": "Yarın bir yemek eleştirmeni bekleniyor.",
    "notice.critic_good": "Eleştirmen memnun ayrıldı ({0}/100).",
    "notice.critic_bad": "Eleştirmen memnun kalmadı ({0}/100).",
